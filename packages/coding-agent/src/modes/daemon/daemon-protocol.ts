...
// Revision 24 lets a primary client provide transient context to recover a resident worker.
export const DAEMON_SCHEMA_REVISION = 24;
export const DAEMON_SCHEMA_ID = "protocol-7-schema-24-649fe649d15e";
